    ...
    .then(data=>{
        ...
        for(i=0;i<data["centers"]["length"];i++)
        {
            ...
            for(j=0;j<no_of_sessions;j++)
            {
                ...
                if(slotsValue>0)
                {
                    content.innerHTML+="<h3>"+hospitalValue+"<br>"+dateofslotValue+"<br><a href='https://selfregistration.cowin.gov.in/' target='_blank'>"+slotsValue+" Slots Open</a></h3>"+"Dose 1: "+ dose1+" "+"Dose 2: "+dose2+"<br>"+"Age:<b>"+minAgeLimit+"</b><br><br>";
                    flag=1;
                }
